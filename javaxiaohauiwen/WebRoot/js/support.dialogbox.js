...
function appendFeedback() {
    ...
    var feedbackIframeInnerHtml =
        ...
        '<div id="feedbackcloseBtn" class="closeBtn" style="position:absolute;right:7px;top:7px;z-index:999;width:17px;height:17px;text-align:center;cursor:pointer;"><img src="images/close_support_x.gif"></div>' +
